...
// Generated on Fri Jul 29 01:16:43 EDT 2016
...
module dft8_top(clk, reset, next, next_out,
   X0, Y0,
   X1, Y1,
   X2, Y2,
   X3, Y3,
...
// latency=31, gap=1
   codeBlock3549 stage0(.clk(clk), .reset(reset), .next_in(next_0), .next_out(next_1),
       .X0_in(t0_0), .Y0(t1_0),
       .X1_in(t0_1), .Y1(t1_1),
       .X2_in(t0_2), .Y2(t1_2),
       .X3_in(t0_3), .Y3(t1_3),
...
// latency=23, gap=1
   codeBlock3913 stage1(.clk(clk), .reset(reset), .next_in(next_1), .next_out(next_2),
       .X0_in(t1_0), .Y0(t2_0),
       .X1_in(t1_1), .Y1(t2_1),
       .X2_in(t1_2), .Y2(t2_2),
       .X3_in(t1_3), .Y3(t2_3),
...
// Latency: 31
// Gap: 1
module codeBlock3549(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(30, 1) shiftFIFO_5246(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y15 = {~(t368[31]), t368[30:0]};
    ...
    addfp32 add3561(.a(a109), .b(a110), .clk(clk), .out(t349), .enable(1'b1), .rst(reset));
    addfp32 add3576(.a(a111), .b(a112), .clk(clk), .out(t350), .enable(1'b1), .rst(reset));
    subfp32 sub3591(.a(a109), .b(a110), .clk(clk), .out(t351), .enable(1'b1), .rst(reset));
    subfp32 sub3606(.a(a111), .b(a112), .clk(clk), .out(t352), .enable(1'b1), .rst(reset));
    addfp32 add3637(.a(a117), .b(a118), .clk(clk), .out(t353), .enable(1'b1), .rst(reset));
    addfp32 add3652(.a(a119), .b(a120), .clk(clk), .out(t354), .enable(1'b1), .rst(reset));
    subfp32 sub3667(.a(a117), .b(a118), .clk(clk), .out(t355), .enable(1'b1), .rst(reset));
    subfp32 sub3682(.a(a119), .b(a120), .clk(clk), .out(t356), .enable(1'b1), .rst(reset));
    addfp32 add3741(.a(a125), .b(a126), .clk(clk), .out(t359), .enable(1'b1), .rst(reset));
    addfp32 add3756(.a(a127), .b(a128), .clk(clk), .out(t360), .enable(1'b1), .rst(reset));
    subfp32 sub3771(.a(a125), .b(a126), .clk(clk), .out(t361), .enable(1'b1), .rst(reset));
    subfp32 sub3786(.a(a127), .b(a128), .clk(clk), .out(t362), .enable(1'b1), .rst(reset));
    addfp32 add3818(.a(a133), .b(a134), .clk(clk), .out(t363), .enable(1'b1), .rst(reset));
    addfp32 add3833(.a(a135), .b(a136), .clk(clk), .out(t364), .enable(1'b1), .rst(reset));
    subfp32 sub3848(.a(a133), .b(a134), .clk(clk), .out(t365), .enable(1'b1), .rst(reset));
    subfp32 sub3863(.a(a135), .b(a136), .clk(clk), .out(t366), .enable(1'b1), .rst(reset));
    multfp32fp32 m3689(.a(tm0), .b(t355), .clk(clk), .out(a105), .enable(1'b1), .rst(reset));
    multfp32fp32 m3696(.a(tm0), .b(t356), .clk(clk), .out(a106), .enable(1'b1), .rst(reset));
    multfp32fp32 m3870(.a(tm0), .b(t366), .clk(clk), .out(a107), .enable(1'b1), .rst(reset));
    multfp32fp32 m3877(.a(tm0), .b(t365), .clk(clk), .out(a108), .enable(1'b1), .rst(reset));
    addfp32 add3703(.a(a105), .b(a106), .clk(clk), .out(t357), .enable(1'b1), .rst(reset));
    subfp32 sub3710(.a(a106), .b(a105), .clk(clk), .out(t358), .enable(1'b1), .rst(reset));
    subfp32 sub3884(.a(a107), .b(a108), .clk(clk), .out(t367), .enable(1'b1), .rst(reset));
    addfp32 add3891(.a(a108), .b(a107), .clk(clk), .out(t368), .enable(1'b1), .rst(reset));
...
// Latency: 23
// Gap: 1
module codeBlock3913(clk, reset, next_in, next_out,
   X0_in, Y0,
   X1_in, Y1,
   X2_in, Y2,
   X3_in, Y3,
   ...
   shiftRegFIFO #(22, 1) shiftFIFO_5249(.X(next), .Y(next_out), .clk(clk));
   ...
   assign Y15 = t240;
    ...
    addfp32 add3925(.a(a33), .b(a34), .clk(clk), .out(t209), .enable(1'b1), .rst(reset));
    addfp32 add3940(.a(a35), .b(a36), .clk(clk), .out(t210), .enable(1'b1), .rst(reset));
    subfp32 sub3955(.a(a33), .b(a34), .clk(clk), .out(t211), .enable(1'b1), .rst(reset));
    subfp32 sub3970(.a(a35), .b(a36), .clk(clk), .out(t212), .enable(1'b1), .rst(reset));
    addfp32 add3985(.a(a41), .b(a42), .clk(clk), .out(t213), .enable(1'b1), .rst(reset));
    addfp32 add4000(.a(a43), .b(a44), .clk(clk), .out(t214), .enable(1'b1), .rst(reset));
    subfp32 sub4015(.a(a41), .b(a42), .clk(clk), .out(t215), .enable(1'b1), .rst(reset));
    subfp32 sub4030(.a(a43), .b(a44), .clk(clk), .out(t216), .enable(1'b1), .rst(reset));
    addfp32 add4133(.a(a49), .b(a50), .clk(clk), .out(t225), .enable(1'b1), .rst(reset));
    addfp32 add4148(.a(a51), .b(a52), .clk(clk), .out(t226), .enable(1'b1), .rst(reset));
    subfp32 sub4163(.a(a49), .b(a50), .clk(clk), .out(t227), .enable(1'b1), .rst(reset));
    subfp32 sub4178(.a(a51), .b(a52), .clk(clk), .out(t228), .enable(1'b1), .rst(reset));
    addfp32 add4193(.a(a57), .b(a58), .clk(clk), .out(t229), .enable(1'b1), .rst(reset));
    addfp32 add4208(.a(a59), .b(a60), .clk(clk), .out(t230), .enable(1'b1), .rst(reset));
    subfp32 sub4223(.a(a57), .b(a58), .clk(clk), .out(t231), .enable(1'b1), .rst(reset));
    subfp32 sub4238(.a(a59), .b(a60), .clk(clk), .out(t232), .enable(1'b1), .rst(reset));
    addfp32 add4037(.a(t209), .b(t213), .clk(clk), .out(t217), .enable(1'b1), .rst(reset));
    addfp32 add4044(.a(t210), .b(t214), .clk(clk), .out(t218), .enable(1'b1), .rst(reset));
    subfp32 sub4051(.a(t209), .b(t213), .clk(clk), .out(t219), .enable(1'b1), .rst(reset));
    subfp32 sub4058(.a(t210), .b(t214), .clk(clk), .out(t220), .enable(1'b1), .rst(reset));
    addfp32 add4081(.a(t211), .b(t216), .clk(clk), .out(t221), .enable(1'b1), .rst(reset));
    subfp32 sub4088(.a(t212), .b(t215), .clk(clk), .out(t222), .enable(1'b1), .rst(reset));
    subfp32 sub4095(.a(t211), .b(t216), .clk(clk), .out(t223), .enable(1'b1), .rst(reset));
    addfp32 add4102(.a(t212), .b(t215), .clk(clk), .out(t224), .enable(1'b1), .rst(reset));
    addfp32 add4245(.a(t225), .b(t229), .clk(clk), .out(t233), .enable(1'b1), .rst(reset));
    addfp32 add4252(.a(t226), .b(t230), .clk(clk), .out(t234), .enable(1'b1), .rst(reset));
    subfp32 sub4259(.a(t225), .b(t229), .clk(clk), .out(t235), .enable(1'b1), .rst(reset));
    subfp32 sub4266(.a(t226), .b(t230), .clk(clk), .out(t236), .enable(1'b1), .rst(reset));
    addfp32 add4289(.a(t227), .b(t232), .clk(clk), .out(t237), .enable(1'b1), .rst(reset));
    subfp32 sub4296(.a(t228), .b(t231), .clk(clk), .out(t238), .enable(1'b1), .rst(reset));
    subfp32 sub4303(.a(t227), .b(t232), .clk(clk), .out(t239), .enable(1'b1), .rst(reset));
    addfp32 add4310(.a(t228), .b(t231), .clk(clk), .out(t240), .enable(1'b1), .rst(reset));
